...
export default function Contact({ onOpenModal }: { onOpenModal: (type: string) => void }) {
  ...
  return (
    <>
      <section className="nb-section nb-section--border-t" id="contact" ref={sectionRef}>
        <div className="nb-container">
          <div className="nb-section-header nb-reveal" style={{ marginBottom: 52 }}>
            <div className="nb-section-label">Get in Touch</div>
            <h2 className="nb-section-h2">Let&apos;s Start Your <em>Journey</em></h2>
            <p className="nb-section-sub">Ready to take the next step? Send us a message and we will get back to you within one business day.</p>
          </div>
